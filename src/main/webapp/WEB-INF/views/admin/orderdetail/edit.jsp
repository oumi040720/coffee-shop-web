...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Coffee Shop | Admin | OrderDeatil</title>
        					...
        					<div class="page-title-box">
        						<div class="page-title-right">
        							<ol class="breadcrumb m-0">
        								...
        								<li class="breadcrumb-item"><a href="javascript: void(0);">Hóa Đơn Chi Tiết</a></li>
        								<c:if test="${check}">
        						...
        						<c:if test="${check}">
        							<h4 class="page-title">Cập nhật hóa đơn chi tiết</h4>
        						</c:if>
        						<c:if test="${!check}">
        							<h4 class="page-title">Thêm mới hóa đơn chi tiết</h4>
        						</c:if>
        					</div>
        				</div>
        			</div>
        				...
        				<div class="col-lg-12">
        					<div class="card-box">
        						<div class="row">
        							...
        							<form:form action="${action}" modelAttribute="orderdetails" cssClass="col-lg-12" 
